...
<html lang="en">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      ...
      <div class="mt-4 p-5 bg-light  rounded" style="height: 600px;">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col d-flex justify-content-center">
                    <a href="customers.php"><img src="https://th.bing.com/th/id/OIP.1c6rgnHJ-9xf66wAHneQGQHaHa?pid=ImgDet&rs=1" class="rounded float-start " height="200" width="200"></a>
                </div>
                <div class="col d-flex justify-content-center">
                    <a href="history.php"><img src="img/history.jpg" class="rounded float-start " height="200" width="200"></a>
                </div>
                <!-- <div class="col d-flex justify-content-center">
